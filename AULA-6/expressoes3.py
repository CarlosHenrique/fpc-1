...
for i in range(T):
    ...
    for e in n:
        if e == '{':
            ...
            if str(pilha_abre._inicio) == '{' and str(pilha_fecha._inicio) == '}':
                pilha_abre.pop()
                pilha_fecha.pop()
            elif str(pilha_abre._inicio) == '[' and str(pilha_fecha._inicio) == ']':
                pilha_abre.pop()
                pilha_fecha.pop()
            elif str(pilha_abre._inicio) == '(' and str(pilha_fecha._inicio) == ')':
                pilha_abre.pop()
    ...
    if pilha_abre.isVazia() and pilha_fecha.isVazia():
        print('S')
    else:
        print('N')
